...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to the saved path or default to home
          ...
          >
            <div className="bg-black/40 backdrop-blur-md rounded-2xl p-8 border border-luxury-gold/20">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-accent text-luxury-gold mb-2">Welcome Back</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between text-sm">
                  <label className="flex items-center text-gray-300">
                    <input
                      type="checkbox"
                      className="form-checkbox rounded border-luxury-gold/20 bg-black/50 text-luxury-gold focus:ring-0"
                    />
